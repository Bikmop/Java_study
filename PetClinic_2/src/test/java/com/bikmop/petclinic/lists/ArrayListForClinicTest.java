...
public class ArrayListForClinicTest {

    //TestGet
    @Test (expected = IndexOutOfBoundsException.class)
    public void testGetEmpty() throws Exception {
        ArrayListForClinic<Object> list = new ArrayListForClinic<>();
    ...
    public void testGetAfterAddOne() throws Exception {
        ArrayListForClinic<String> list = new ArrayListForClinic<>();
        list.add("test");
    ...
    public void testIsEmptyTrueIncreaseLength() throws Exception {
        ArrayListForClinic<Integer> list = new ArrayListForClinic<>();
    ...
    public void testNullListGet() throws Exception {
        ArrayListForClinic<Object> list = null;
        list.get(0);
    }
